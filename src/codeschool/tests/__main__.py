...
from codeschool import __version__
...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('codeschool')
...
def main(args=None):
    """
    Called with ``python -m codeschool.tests``: run main test suite.
    """
    ...
    import codeschool.tests as test_module
