...
#: A regular expression string for validating school id values. Set it to
#: None to disable validation. It can also by a Python function that raises
#: django.core.exceptions.ValidationError for invalid school ids.
...
CODESCHOOL_SANDBOX = not DEBUG

#: Enable debug views at _admin/ and _debug/
CODESCHOOL_DEBUG_VIEWS = DEBUG
