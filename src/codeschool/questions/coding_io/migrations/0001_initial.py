    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='files.ProgrammingLanguage')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_pre_tests', models.PositiveIntegerField(default=3, help_text='The desired number of test cases that will be computed after comparing the iospec template with the correct answer. This is only a suggested value and will only be applied if the response template uses input commands to generate random input.', validators=[codeschool.questions.coding_io.validators.positive_integer_validator], verbose_name='# of pre-test examples')),
                ('pre_tests_source', models.TextField(blank=True, help_text='Template used to grade I/O responses. See http://pythonhosted.org/iospec for a complete reference on the template format.', validators=[codeschool.questions.coding_io.validators.iospec_source_validator], verbose_name='response template')),
                ('num_post_tests', models.PositiveIntegerField(default=20, validators=[codeschool.questions.coding_io.validators.positive_integer_validator], verbose_name='# of post-test examples')),
                ('post_tests_source', models.TextField(blank=True, help_text='These tests are used only in a second round of corrections and is not immediately shown to users.', validators=[codeschool.questions.coding_io.validators.iospec_source_validator], verbose_name='response template (post evaluation)')),
                ('test_state_hash', models.CharField(blank=True, help_text='A hash to keep track of iospec sources updates.', max_length=32)),
                ('timeout', models.FloatField(blank=True, default=1.0, help_text='Defines the maximum runtime the grader will spend evaluating each test case.', validators=[codeschool.questions.coding_io.validators.timeout_validator], verbose_name='timeout in seconds')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='files.ProgrammingLanguage')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='question_codingio.CodingIoQuestion')),
            ],
        ),
        migrations.AddField(
            model_name='answerkey',
            name='question',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='question_codingio.CodingIoQuestion'),
        ),
